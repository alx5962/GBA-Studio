...
var S3mModule = function (fileData) {
  ...
  for (var p = 0; p < this.patternCount; p++) {
    var patternOffset =
      Helpers.readWord(fileData, patternPtrOffset + p * 2) * 16;
